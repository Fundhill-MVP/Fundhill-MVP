...
export default function OptionModal({loanId}) {
    ...
    const add_borrower = async (values) => {
          try {
            ...
            const response = await api
              .service()
              .push("/dashboard/group-loan/add/", values, true)
    ...
    return (
        <div>
            <Button variant='contained' style={{ textTransform: 'none' }} onClick={()=> [handleOpen(),getCustomer(loanId)]} >Assign Loan</Button>
            <Modal
