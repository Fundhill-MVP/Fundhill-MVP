                    ...
                    <Box sx={style}>
                        ...
                        <form style={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div className={classes.formDiv}>
                                ...
                                <TextField fullWidth variant='outlined' type="text" name="" size='small' placeholder='Interest Name' required />
                            ...
                            <div className={classes.formDiv}>
                                <div className={classes.divTypo}><Typography>Minimum Time (%)</Typography></div>
                                <TextField fullWidth variant='outlined' type="number" name="" size='small' placeholder='Minimum Time (%)' required />

                            </div>

                            <div className={classes.formDiv}>
                                <div className={classes.divTypo}><Typography>Maximum Time (%)</Typography></div>
                                <TextField fullWidth variant='outlined' type="number" name="" size='small' placeholder='Maximum Time (%)' required />
