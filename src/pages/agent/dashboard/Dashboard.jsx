                  ...
                  >
                    ...
                    >
                      <Grid item xs={12} className={classes.rateGrid}>
                        <Button variant='outlined' className={classes.btnSeeMore} onClick={() => { navigate('/agent/dashboard/customer/allcustomer') }}>See more</Button>
                      </Grid>
                    </Grid>
                  </Widget>
                </Grid>
                    ...
                    >
                      <Grid item xs={12} className={classes.rateGrid}>
                        <Button variant='outlined' className={classes.btnSeeMore} onClick={() => {
                          navigate('/agent/dashboard/tranxs/total_deposits')
                        }}>See more</Button>
                      </Grid>
                    </Grid>
                  </Widget>
                ...
                <Grid item lg={3} md={4} sm={6} xs={12}>
                  ...
                  >
                    ...
                    >
                      <Grid item xs={12} className={classes.rateGrid}>
                        <Button variant='outlined' className={classes.btnSeeMore} onClick={
                          () => navigate('/agent/dashboard/tranxs/total_withdrawals')
                        }>See more</Button>
                      </Grid>
                    </Grid>
                  </Widget>
                ...
                <Grid item lg={3} md={4} sm={6} xs={12}>
                  ...
                  >
                    ...
                    >
                      <Grid item xs={12} className={classes.rateGrid}>
                        <Button variant='outlined' className={classes.btnSeeMore} onClick={() => {
                          navigate('/agent/dashboard/loan/ongoing_loan')
                        }}>See more</Button>
                      </Grid>
                    </Grid>
                  </Widget>
                ...
                <Grid item lg={3} md={4} sm={6} xs={12}>
                  ...
                  >
                    ...
                    >
                      <Grid item xs={12} className={classes.rateGrid}>
                        <Button variant='outlined' className={classes.btnSeeMore} onClick={() => {
                          navigate('/agent/dashboard/expense/all_expenses')
                        }}>See more</Button>
                      </Grid>
                    </Grid>
                  </Widget>
                ...
                <Grid item lg={3} md={4} sm={6} xs={12}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid item xs={12} className={classes.rateGrid}>
                        <Button variant='outlined' className={classes.btnSeeMore} onClick={() => { navigate('/agent/dashboard/group/all_group') }}>See more</Button>
                      </Grid>
                    </Grid>
                  </Widget>
                </Grid>
